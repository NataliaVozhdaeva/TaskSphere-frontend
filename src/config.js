...
export const config = {
  ...
  app: {
    ...
    description: process.env.REACT_APP_DESCRIPTION || 'Task Management Application',
  },
  ...
  services: {
    sentry: {
      ...
      environment: process.env.REACT_APP_SENTRY_ENVIRONMENT || process.env.REACT_APP_ENVIRONMENT,
    },
    analytics: {
