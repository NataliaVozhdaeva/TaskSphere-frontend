...
function App() {
  ...
  const fetchTasks = async () => {
    try {
      ...
      setError(`Failed to fetch tasks (${err.response?.status}). Make sure the backend server is running on http://localhost:8000`);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        {error && (
          <div style={{ backgroundColor: '#ff6b6b', padding: '10px', margin: '10px 0', borderRadius: '5px' }}>
            {error}
          </div>
        )}
        ...
        {!isAuthenticated ? (
          <div style={{ width: '100%', maxWidth: '400px' }}>
            ...
            {showLogin ? (
              <div style={{ backgroundColor: 'rgba(255,255,255,0.1)', padding: '20px', borderRadius: '5px' }}>
                <h3>Login</h3>
                <form onSubmit={(e) => {
                  e.preventDefault();
          ...
          <div style={{ width: '100%', maxWidth: '800px', margin: '20px 0' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <button onClick={handleLogout} style={{ padding: '10px 20px', backgroundColor: '#ff6b6b' }}>
                Logout
              </button>
            </div>
            {loading ? (
                      ...
                      <div key={task.id} style={{ 
                        ...
                        <div style={{ marginTop: '10px' }}>
                          ...
                          <button 
                            ...
                            style={{ padding: '5px 10px', backgroundColor: '#ff6b6b' }}
                          >
                            Delete
                          </button>
                        </div>
